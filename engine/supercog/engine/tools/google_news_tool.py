...
class GoogleNewsTool(ToolFactory):
    def __init__(self):
        super().__init__(
...
""",
    ...
    def get_top_headlines(self, language: str = 'en', country: str = 'US') -> List[NewsItem]:
    ...
    def query_topic(self, topic: str, language: str = 'en', country: str = 'US') -> List[NewsItem]:
    ...
    def query_news(self, query: str, language: str = 'en', country: str = 'US', 
        ...
        Args:
            ...
            before (date, optional): End date for the search range.
            after (date, optional): Start date for the search range.
            when (str, optional): Time range specifier (e.g., '1h', '7d', '1m').
        ...
        Returns:
            List[NewsItem]: A list of news articles matching the search criteria.
        """
        gnf = GoogleNewsFeed(language=language, country=country)
        ...
        results = gnf.query(query, before=before, after=after, when=when)
        return results
